...
export default function CustomPeriodsGrid({ groupedDates, selectedPeriods, togglePeriod, busyPeriods }: CustomPeriodsGridProps) {
    return (
        <div className="mb-4">
            <h4 className="text-[10px] font-semibold text-muted-foreground mb-1 uppercase tracking-tight">カスタム枠設定</h4>
            <div className="grid grid-cols-3 md:grid-cols-4 gap-1">
                {CUSTOM_PERIODS.map((p: any) => {
                    ...
                    const isBusy = busyPeriods?.includes(`${dateStr}_P${p.id}`);
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className="text-[9px] opacity-80 leading-none scale-90 origin-center whitespace-nowrap">
